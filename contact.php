...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'intwariinnocent70@gmail.com';        // Your Gmail account (used for authentication)
        $mail->Password   = 'ubeb ftkj udmk tbjh';           // Your App-specific password
        ...
        $mail->setFrom('kitumukunde@gmail.com', 'Suggestions&Questions');
        ...
        $mail->addAddress('intwariinnocent70@gmail.com');
